...
function bundle(graph) {
  ...
  // require, module, exports 是cjs的标准 不能在浏览器中直接使用，所以这里模拟cjs模块加载，执行，导出操作
  const result = `
  (function(modules){
    // 创建require函数，他接受一个模块ID（这个模块id是数字0，1，2），它会在我们上面定义的modules里找到对应的模块
    function require(id){
...
const breautify_ret = beautify(ret, { indent_size: 2, space_in_empty_paren: true })
// 打包生成文件
fs.writeFileSync("./bundle.js", breautify_ret)